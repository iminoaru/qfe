...
export function InfiniteCards() {
    return (
        ...
        <div id="reviews" className="h-[40rem] rounded-md flex flex-col antialiased bg-white dark:bg-neutral-950  dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
